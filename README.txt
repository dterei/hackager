...
Caution: This program can cause arbitrary code to run on your machine.
For example, if any modules use TH, then the TH will be executed.
configure scripts will be run. Custom Setup.hs programs will be run.
